...
Также для увеличения скорости работы полносвязных слоев на выходе (дает хорошее улучшения скорости, когда количество RoI регионов большое количество) используется уменьшение слоя с помощью truncated singular value decomposition (<img src="https://render.githubusercontent.com/render/math?math=SVD = U\sum_{t}V^T">) путем создания двух слоев меньших размеров <img src="https://render.githubusercontent.com/render/math?math=\sum_{t}V^T"> (матрица весов) и матрицы <img src="https://render.githubusercontent.com/render/math?math=U">.
